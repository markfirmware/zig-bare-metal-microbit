...
comptime {
    asm (
        \\.section .text.start.mission04
        \\.globl mission04_vector_table
        \\.balign 0x80
        \\mission04_vector_table:
        \\ .long 0x20004000 // sp top of 16KB ram
        \\ .long mission04_main
        \\ .long mission04_exceptionNumber02
        \\ .long mission04_exceptionNumber03
        \\ .long mission04_exceptionNumber04
        \\ .long mission04_exceptionNumber05
        \\ .long mission04_exceptionNumber06
        \\ .long mission04_exceptionNumber07
        \\ .long mission04_exceptionNumber08
        \\ .long mission04_exceptionNumber09
        \\ .long mission04_exceptionNumber10
        \\ .long mission04_exceptionNumber11
        \\ .long mission04_exceptionNumber12
        \\ .long mission04_exceptionNumber13
        \\ .long mission04_exceptionNumber14
        \\ .long mission04_exceptionNumber15
    );
}

export fn mission04_exceptionNumber01() noreturn {
    lib.exceptionHandler(01);
}

export fn mission04_exceptionNumber02() noreturn {
    lib.exceptionHandler(02);
}

export fn mission04_exceptionNumber03() noreturn {
    lib.exceptionHandler(03);
}

export fn mission04_exceptionNumber04() noreturn {
    lib.exceptionHandler(04);
}

export fn mission04_exceptionNumber05() noreturn {
    lib.exceptionHandler(05);
}

export fn mission04_exceptionNumber06() noreturn {
    lib.exceptionHandler(06);
}

export fn mission04_exceptionNumber07() noreturn {
    lib.exceptionHandler(07);
}

export fn mission04_exceptionNumber08() noreturn {
    lib.exceptionHandler(08);
}

export fn mission04_exceptionNumber09() noreturn {
    lib.exceptionHandler(09);
}

export fn mission04_exceptionNumber10() noreturn {
    lib.exceptionHandler(10);
}

export fn mission04_exceptionNumber11() noreturn {
    lib.exceptionHandler(11);
}

export fn mission04_exceptionNumber12() noreturn {
    lib.exceptionHandler(12);
}

export fn mission04_exceptionNumber13() noreturn {
    lib.exceptionHandler(13);
}

export fn mission04_exceptionNumber14() noreturn {
    lib.exceptionHandler(14);
}

export fn mission04_exceptionNumber15() noreturn {
