...
comptime {
    asm (
        ...
        \\ .long mission05_main
        \\ .long mission05_exceptionNumber02
        \\ .long mission05_exceptionNumber03
        \\ .long mission05_exceptionNumber04
        \\ .long mission05_exceptionNumber05
        \\ .long mission05_exceptionNumber06
        \\ .long mission05_exceptionNumber07
        \\ .long mission05_exceptionNumber08
        \\ .long mission05_exceptionNumber09
        \\ .long mission05_exceptionNumber10
        \\ .long mission05_exceptionNumber11
        \\ .long mission05_exceptionNumber12
        \\ .long mission05_exceptionNumber13
        \\ .long mission05_exceptionNumber14
        \\ .long mission05_exceptionNumber15
    );
}

export fn mission05_exceptionNumber01() noreturn {
    lib.exceptionHandler(01);
}

export fn mission05_exceptionNumber02() noreturn {
    lib.exceptionHandler(02);
}

export fn mission05_exceptionNumber03() noreturn {
    lib.exceptionHandler(03);
}

export fn mission05_exceptionNumber04() noreturn {
    lib.exceptionHandler(04);
}

export fn mission05_exceptionNumber05() noreturn {
    lib.exceptionHandler(05);
}

export fn mission05_exceptionNumber06() noreturn {
    lib.exceptionHandler(06);
}

export fn mission05_exceptionNumber07() noreturn {
    lib.exceptionHandler(07);
}

export fn mission05_exceptionNumber08() noreturn {
    lib.exceptionHandler(08);
}

export fn mission05_exceptionNumber09() noreturn {
    lib.exceptionHandler(09);
}

export fn mission05_exceptionNumber10() noreturn {
    lib.exceptionHandler(10);
}

export fn mission05_exceptionNumber11() noreturn {
    lib.exceptionHandler(11);
}

export fn mission05_exceptionNumber12() noreturn {
    lib.exceptionHandler(12);
}

export fn mission05_exceptionNumber13() noreturn {
    lib.exceptionHandler(13);
}

export fn mission05_exceptionNumber14() noreturn {
    lib.exceptionHandler(14);
}

export fn mission05_exceptionNumber15() noreturn {
