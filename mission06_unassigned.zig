export fn mission06_main() noreturn {
    Bss.prepare();
    Exceptions.prepare();
    Timer0.prepare();
    Timer1.prepare();
...
comptime {
    asm (
        \\.section .text.start.mission06
        \\.globl mission06_vector_table
        \\.balign 0x80
        \\mission06_vector_table:
        \\ .long 0x20004000 // sp top of 16KB ram
        \\ .long mission06_main
        \\ .long mission06_exceptionNumber02
        \\ .long mission06_exceptionNumber03
        \\ .long mission06_exceptionNumber04
        \\ .long mission06_exceptionNumber05
        \\ .long mission06_exceptionNumber06
        \\ .long mission06_exceptionNumber07
        \\ .long mission06_exceptionNumber08
        \\ .long mission06_exceptionNumber09
        \\ .long mission06_exceptionNumber10
        \\ .long mission06_exceptionNumber11
        \\ .long mission06_exceptionNumber12
        \\ .long mission06_exceptionNumber13
        \\ .long mission06_exceptionNumber14
        \\ .long mission06_exceptionNumber15
    );
}

export fn mission06_exceptionNumber01() noreturn {
    lib.exceptionHandler(01);
}

export fn mission06_exceptionNumber02() noreturn {
    lib.exceptionHandler(02);
}

export fn mission06_exceptionNumber03() noreturn {
    lib.exceptionHandler(03);
}

export fn mission06_exceptionNumber04() noreturn {
    lib.exceptionHandler(04);
}

export fn mission06_exceptionNumber05() noreturn {
    lib.exceptionHandler(05);
}

export fn mission06_exceptionNumber06() noreturn {
    lib.exceptionHandler(06);
}

export fn mission06_exceptionNumber07() noreturn {
    lib.exceptionHandler(07);
}

export fn mission06_exceptionNumber08() noreturn {
    lib.exceptionHandler(08);
}

export fn mission06_exceptionNumber09() noreturn {
    lib.exceptionHandler(09);
}

export fn mission06_exceptionNumber10() noreturn {
    lib.exceptionHandler(10);
}

export fn mission06_exceptionNumber11() noreturn {
    lib.exceptionHandler(11);
}

export fn mission06_exceptionNumber12() noreturn {
    lib.exceptionHandler(12);
}

export fn mission06_exceptionNumber13() noreturn {
    lib.exceptionHandler(13);
}

export fn mission06_exceptionNumber14() noreturn {
    lib.exceptionHandler(14);
}

export fn mission06_exceptionNumber15() noreturn {
