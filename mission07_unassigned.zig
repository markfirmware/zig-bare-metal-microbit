export fn mission07_main() noreturn {
    Bss.prepare();
    Exceptions.prepare();
    Timer0.prepare();
    Timer1.prepare();
...
comptime {
    asm (
        \\.section .text.start.mission07
        \\.globl mission07_vector_table
        \\.balign 0x80
        \\mission07_vector_table:
        \\ .long 0x20004000 // sp top of 16KB ram
        \\ .long mission07_main
        \\ .long mission07_exceptionNumber02
        \\ .long mission07_exceptionNumber03
        \\ .long mission07_exceptionNumber04
        \\ .long mission07_exceptionNumber05
        \\ .long mission07_exceptionNumber06
        \\ .long mission07_exceptionNumber07
        \\ .long mission07_exceptionNumber08
        \\ .long mission07_exceptionNumber09
        \\ .long mission07_exceptionNumber10
        \\ .long mission07_exceptionNumber11
        \\ .long mission07_exceptionNumber12
        \\ .long mission07_exceptionNumber13
        \\ .long mission07_exceptionNumber14
        \\ .long mission07_exceptionNumber15
    );
}

export fn mission07_exceptionNumber01() noreturn {
    lib.exceptionHandler(01);
}

export fn mission07_exceptionNumber02() noreturn {
    lib.exceptionHandler(02);
}

export fn mission07_exceptionNumber03() noreturn {
    lib.exceptionHandler(03);
}

export fn mission07_exceptionNumber04() noreturn {
    lib.exceptionHandler(04);
}

export fn mission07_exceptionNumber05() noreturn {
    lib.exceptionHandler(05);
}

export fn mission07_exceptionNumber06() noreturn {
    lib.exceptionHandler(06);
}

export fn mission07_exceptionNumber07() noreturn {
    lib.exceptionHandler(07);
}

export fn mission07_exceptionNumber08() noreturn {
    lib.exceptionHandler(08);
}

export fn mission07_exceptionNumber09() noreturn {
    lib.exceptionHandler(09);
}

export fn mission07_exceptionNumber10() noreturn {
    lib.exceptionHandler(10);
}

export fn mission07_exceptionNumber11() noreturn {
    lib.exceptionHandler(11);
}

export fn mission07_exceptionNumber12() noreturn {
    lib.exceptionHandler(12);
}

export fn mission07_exceptionNumber13() noreturn {
    lib.exceptionHandler(13);
}

export fn mission07_exceptionNumber14() noreturn {
    lib.exceptionHandler(14);
}

export fn mission07_exceptionNumber15() noreturn {
